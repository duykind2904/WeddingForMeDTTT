const ParentsInviteComponent = {
  template: `
    <section class="pi-section fade-in">
      ...
      <!-- Thông tin sự kiện -->
      <div class="pi-event">
        <p class="pi-event-venue">Hôn Lễ Được Cử Hành Tại Tư Gia</p>
        <p class="pi-event-time">Vào lúc 09 giờ 00</p>
        <p class="pi-event-date">Chủ Nhật&nbsp;|&nbsp;14.06.2026</p>
        <p class="pi-event-lunar">(Nhằm ngày 29 tháng 04 năm Bính Ngọ)</p>
      </div>
